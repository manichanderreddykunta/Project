...
mysqli_query($con,"insert into products (product_cat, product_brand,product_title,product_price, product_desc, product_image,product_keywords, size, color, quantity) values ('$product_type','$brand','$product_name','$price','$details','$pic_name','$tags','$size','$color', '100')") or die ("query incorrect");
